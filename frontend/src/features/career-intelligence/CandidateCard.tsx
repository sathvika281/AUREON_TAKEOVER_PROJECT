  ...
  return (
    <Surface tone="raised" padding="md">
      ...
      <div className="mt-3 flex items-center justify-between border-t border-border pt-3">
        <span className="font-mono text-xs text-accent-soft">{candidate.evidence_strength}</span>
        <Link
          to={`/explore/career-reality/${candidate.career_id}`}
          className="text-right text-xs text-ink-faint transition-colors hover:text-ink"
        >
