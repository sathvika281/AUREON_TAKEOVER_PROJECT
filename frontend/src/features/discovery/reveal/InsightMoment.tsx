    ...
    <AnimatePresence>
      {line && (
        <motion.div
          ...
          className="fixed inset-0 z-40 flex items-center justify-center bg-[#070B18]/88"
        >
          <motion.p
            ...
            className="max-w-md px-8 text-center font-serif text-xl italic leading-relaxed text-[#F2EDE0]"
          >
            {line}
          </motion.p>
        </motion.div>
